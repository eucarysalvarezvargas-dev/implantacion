        ...
        <div class="relative pl-4 md:pl-8 space-y-8">
            ...
            @forelse($historial ?? [] as $registro)
                ...
                <div class="relative animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <!-- Date Label (Mobile: Top, Desktop: Side usually but keeping simple vertical here) -->
                    <div class="pl-8">
                        <span class="inline-block px-3 py-1 rounded-lg bg-slate-100 dark:bg-gray-800 text-xs font-bold text-slate-500 mb-2">
                             {{ isset($registro->created_at) ? \Carbon\Carbon::parse($registro->created_at)->format('d M Y, h:i A') : 'Fecha desconocida' }}
                        </span>
                            ...
                            <div class="flex flex-col sm:flex-row gap-5">
                                ...
                                <div class="flex-1 min-w-0 space-y-3">
                                    <div class="flex items-start justify-between">
                                        <div>
                                            <h3 class="text-lg font-bold text-slate-800 dark:text-white">{{ $registro->titulo ?? 'Registro Médico' }}</h3>
