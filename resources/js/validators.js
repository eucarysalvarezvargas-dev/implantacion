...
export function showFieldFeedback(input, result) {
    ...
    if (!feedbackElement) {
        ...
        feedbackElement.className = 'field-feedback text-sm mt-1 flex items-center gap-1';
    ...
    if (result.valid) {
        ...
        feedbackElement.className = 'field-feedback text-sm mt-1 flex items-center gap-1 text-success-600';
        feedbackElement.innerHTML = `<i class="bi bi-check-circle-fill"></i> ${result.message}`;
    } else if (input.value.length > 0) {
        input.classList.add('input-error');
        feedbackElement.className = 'field-feedback text-sm mt-1 flex items-center gap-1 text-danger-600';
